package com.lonewolfworks.wolke.rds.credentialbroker.config

import com.lonewolfworks.wolke.rds.credentialbroker.broker.Credential
...
open class DataSourceConfig {
    ...
    @Bean
    @Profile("postgres", "mysql", "mysqliam", "mysql56")
